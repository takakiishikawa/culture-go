...
export default function ConceptRoute() {
  return (
    <ConceptPage
      ...
      coreMessage="瑣末な情報を浴びるのをやめ、世界の方向を変える構造シフトだけを週1で受け取る。Claude 対話への深掘りトリガーを置き、興味タグから世界の方向と会話の幅を広げる足場をつくる。"
      coreValue="興味タグ × 構造シフト = 深掘りの起点。情報量で勝負しない、編集された静けさ。"
      scope={{
        solve: [
          "週1で構造シフトを AI が検出して配信",
          "興味ドメインに沿ったトリガーの提供",
